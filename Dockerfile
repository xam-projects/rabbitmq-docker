...
LABEL name=rabbitmq:1.0.0 version=1.0.0
...
ENV CONSUL_SVC=rabbitmq
ENV CONSUL_SVC_ADDR_AUTO=true
ENV RABBITMQ_ERLANG_COOKIE=RABBITMQ36AMQP09D201906
...
# rabbitmqctl add_user guest guest; rabbitmqctl set_permissions -p / guest ".*" ".*" ".*"
